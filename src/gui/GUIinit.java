...
public class GUIinit {
	...
	static JTextField txtGegnername;
	static JPasswordField pwdSchlssel;
	static String schnittstelle;
	static String spielerwahl;
	static JTextField txtPath;
	private static JTable game;
	...
	private static Object[][] data_stat;
	 ...
	 * Erzeuge Applikation.
	 */
	public GUIinit(Intelligence ki) {
		this.ki = ki;
		initialize();
	}

	// CODE START NUR ZU TESTZWECKEN cornemrc
	private void satzendePopup() {
		...
		int auswahl = JOptionPane.showOptionDialog(frame, "Wer hat gewonnen?", "Satzende",
				...
				new String[] { "Fungi", "set_gegner", "Unentschieden", "Satz wiederholen!" }, "Fungi");
		System.out.println(auswahl);
	}

	private void spielendePopup() {
		// Siegervariable ergänzen!
		JOptionPane.showMessageDialog(frame, "Gewonnen hat: ", "Spielende", 1);
	}
	...
	private void initialize() {
		...
		JLabel lblSetgegner = new JLabel("set_gegner");
		...
		btnPopupTestSatzende.setBounds(1054, 31, 200, 29);
		...
		// Array für GEGNER Selektionsbox
		String[] gegnerArray = new String[4];
		gegnerArray[0] = "Team 1";
		gegnerArray[1] = "Team 2";
		gegnerArray[2] = "Team 3";
		gegnerArray[3] = "Team 4";

		JComboBox comboBox1 = new JComboBox(gegnerArray);
